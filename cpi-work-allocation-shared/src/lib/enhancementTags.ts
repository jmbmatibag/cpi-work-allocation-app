 ...
 */
export const DEFAULT_ENHANCEMENT_TAGS: readonly string[] = [
  'MTC API',
  'Smart Claims',
  'OAuth/OIDC',
...
export function isSpecificEnhancement(workType: string | null | undefined): boolean {
 ...
 */
export function isKnownEnhancementTag(
